...
class BasedOnRequestMonthlyDataExport implements FromView
{
    public function view():View
    {
        ...
        // dd($procurements);
        return view ('documentation.request.monthly-result', compact('procurements', 'periodFormatted', 'monthName'));
    }
}
