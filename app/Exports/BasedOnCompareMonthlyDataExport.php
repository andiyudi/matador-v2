...
class BasedOnCompareMonthlyDataExport implements FromView
{
    public function view(): View
    {
        ...
        // dd($procurements);
        return view ('documentation.compare.monthly-result', compact('procurements', 'periodFormatted', 'monthName'));
    }
}
