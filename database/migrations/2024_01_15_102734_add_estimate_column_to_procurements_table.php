...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('procurements', function (Blueprint $table) {
            ...
            $table->date('ppoe_accepted')->nullable()->default(NULL)->after('deal_nego');
            ...
            $table->string('information')->nullable()->default(NULL)->after('cancellation_memo');
            $table->string('op_number')->nullable()->default(NULL)->after('information');
