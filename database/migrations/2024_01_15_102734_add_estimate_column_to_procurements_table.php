...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('procurements', function (Blueprint $table) {
            ...
            $table->date('tender_result')->nullable()->default(NULL)->after('renegotiation_result');
            $table->date('director_agreement')->nullable()->default(NULL)->after('tender_result');
            $table->date('legal_accept')->nullable()->default(NULL)->after('director_agreement');
    ...
    public function down(): void
    {
        Schema::table('procurements', function (Blueprint $table) {
            ...
            $table->dropColumn('tender_result');
            $table->dropColumn('director_agreement');
