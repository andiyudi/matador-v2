...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('procurements', function (Blueprint $table) {
            ...
            // $table->date('ppoe_accepted')->nullable()->default(NULL)->after('director_approval');
            ...
            // $table->string('op_number')->nullable()->default(NULL)->after('departement_disposition');
            // $table->string('contract_number')->nullable()->default(NULL)->after('op_number');
            // $table->string('contract_value')->nullable()->default(NULL)->after('contract_number');
            // $table->date('contract_date')->nullable()->default(NULL)->after('contract_value');
            // $table->date('disposition_second_tender')->nullable()->default(NULL)->after('contract_date');
