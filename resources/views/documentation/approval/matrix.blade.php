<div class="tab-pane fade show active" id="matrixContent" role="tabpanel" aria-labelledby="matrixTab">
    ...
    <div class="form-group">
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-sm-3">
            ...
            <a href="{{ route('documentation.approval-monthly-excel') }}" class="btn btn-success" id="exportBtn">Export</a>
        </div>
    </div>
    <iframe id="searchApprovalMonthly" src="" style="width: 100%; height: 500px; border: none;"></iframe>
</div>
...
<script>
    $(document).ready(function() {
        ...
        //tampilan data
        var iframeSrc = '{{ route('documentation.approval-monthly-data') }}?period=' + encodeURIComponent(period) +
            '&number=' + encodeURIComponent(number) +
            '&division=' + encodeURIComponent(division);
        console.log(iframeSrc);
        $('#searchApprovalMonthly').attr('src', iframeSrc);
        }
        ...
        var url = $('#searchApprovalMonthly').attr('src');
         // Validasi form
