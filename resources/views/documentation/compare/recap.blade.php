<div class="tab-pane fade" id="recapContent" role="tabpanel" aria-labelledby="recapTab">
    ...
    <div class="form-group">
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-3">
            ...
            <a href="{{ route('documentation.compare-annual-excel') }}" class="btn btn-success" id="btnExport">Export</a>
        </div>
    </div>
    <iframe id="searchCompareAnnual" src="" style="width: 100%; height: 500px; border: none;"></iframe>
</div>
...
<script>
    ...
    function updateIframe() {
        ...
        var iframeSrc = '{{ route('documentation.compare-annual-data') }}?year=' + year +
        '&start_month=' + start_month +
        '&end_month=' + end_month;
        console.log(iframeSrc);
        $('#searchCompareAnnual').attr('src', iframeSrc);
    }
    $('#btnPrint').click(function() {
        ...
        var url = $('#searchCompareAnnual').attr('src');
         // Validasi form
