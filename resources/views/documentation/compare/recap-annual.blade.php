...
<head>
    ...
    <title>Annual Recapitulation by Compare</title>
</head>
<body>
    <style>
        @media print{
        ...
        .peserta-rapat tfoot tr:last-child {
...
<p style="text-align: center; font-size: 14pt">
    REKAPITULASI PERBANDINGAN<br>
    NILAI RKAP VS NEGOSIASI - NILAI VERIFIKASI TEKNIK VS NEGOSIASI<br>
    @php
        $bulan = [
        '01' => 'JANUARI',
        '02' => 'FEBRUARI',
...
@include('documentation.compare.annual-result')
<table width="100%">
    <thead>
        <tr>
