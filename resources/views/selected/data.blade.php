...
<head>
    ...
    <title>Monitoring Selected</title>
</head>
<body>
    <style>
        @media print{
        ...
        .peserta-rapat th {
            background-color:rgba(155, 40, 40, 0.4);
...
<p style="text-align: center; font-size: 14pt">
    DAFTAR MITRA KERJA / VENDOR<br>
    PEMENANG TENDER BARANG & JASA<br>
    @if($start_month === $end_month)
    PERIODE : {{ strtoupper($start_month_name) }} {{ $year }}
    @else
        PERIODE : {{ strtoupper($start_month_name) }} - {{ strtoupper($end_month_name) }} {{ $year }}
    @endif

</p>
@include('selected.result')
<table width="100%">
    <thead>
        <tr>
