                ...
                <form action="{{ route('partner.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="Input Email">
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control curencyField @error('capital') is-invalid @enderror" id="capital" name="capital" value="{{ old('capital') }}" placeholder="Input Capital">
                                @error('capital')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
