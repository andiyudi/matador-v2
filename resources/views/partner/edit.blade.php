                ...
                <form action="{{ route('partner.update',  ['partner' => $partner->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ $partner->email }}">
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="date" class="form-control @error('start_deed') is-invalid @enderror" id="start_deed" name="start_deed" value="{{ $partner->start_deed }}">
                            @error('start_deed')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col mb-3">
                            ...
                            <input type="date" class="form-control @error('end_deed') is-invalid @enderror" id="end_deed" name="end_deed" value="{{ $partner->end_deed }}">
                            @error('end_deed')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control curencyField @error('capital') is-invalid @enderror" id="capital" name="capital" value="{{ $partner->capital }}">
                            </div>
                            @error('capital')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
