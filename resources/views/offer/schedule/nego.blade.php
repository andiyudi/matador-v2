<div id="form_type_2" style="display:none;">
    <form action="{{ route('schedule.store') }}" method="POST">
        ...
        <table class="table table-responsive table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" name="duration_3" id="nego_duration_3" value="0" readonly>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" name="duration_4" id="nego_duration_4" value="0" readonly>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" name="duration_5" id="nego_duration_5" value="0" readonly>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" name="duration_6" id="nego_duration_6" value="0" readonly>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" name="duration_7" id="nego_duration_7" value="0" readonly>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" name="duration_8" id="nego_duration_8" value="0" readonly>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" name="duration_9" id="nego_duration_9" value="0" readonly>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="form-floating">
            <textarea class="form-control" placeholder="Leave a comment here" name="note" id="note" style="height:100px">
            </textarea>
