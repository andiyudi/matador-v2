        ...
        <table class="table table-responsive table-bordered table-striped table-hover">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" name="duration_1" id="normal_duration_1" value="0" min="0">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" name="duration_2" id="normal_duration_2" value="0" min="0">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" name="duration_3" id="normal_duration_3" value="0" min="0">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" name="duration_4" id="normal_duration_4" value="0" min="0">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" name="duration_5" id="normal_duration_5" value="0" min="0">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" name="duration_6" id="normal_duration_6" value="0" min="0">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" name="duration_7" id="normal_duration_7" value="0" min="0">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" name="duration_8" id="normal_duration_8" value="0" min="0">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" name="duration_9" id="normal_duration_9" value="0" min="0">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" name="duration_10" id="normal_duration_10" value="0" min="0">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" name="duration_11" id="normal_duration_11" value="0" min="0">
                    </td>
                </tr>
            </tbody>
        </table>
