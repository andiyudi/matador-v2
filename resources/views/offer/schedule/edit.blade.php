    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to delete the schedule? This action is irreversible! Please create a new schedule for this tender.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <form method="POST" action="{{ route('schedule.destroy', $tender->id) }}">
                    @csrf
                    @method('DELETE')
