...
<body>
    <div class="container">
        ...
        <p>Bersama ini kami laporkan hasil negosiasi <strong>{{ ucwords(strtolower($tender->procurement->name)) }}</strong> dengan No. PR: {{ $tender->procurement->number }} sebagai berikut:</p>
