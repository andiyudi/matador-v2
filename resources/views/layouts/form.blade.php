...
<html lang="en">
  <head>
    ...
    <meta name="canonical" content="https://preview.tabler.io/form-elements.html">
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <a href="{{ asset ('') }}assets/profile.html" class="dropdown-item">Profile</a>
            ...
            <div class="container-xl">
              <ul class="navbar-nav">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ asset ('') }}assets/alerts.html">
                          Alerts
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/accordion.html">
                          Accordion
                        </a>
                        <div class="dropend">
                          ...
                          <div class="dropdown-menu">
                            <a href="{{ asset ('') }}assets/sign-in.html" class="dropdown-item">
                              Sign in
                            </a>
                            <a href="{{ asset ('') }}assets/sign-in-link.html" class="dropdown-item">
                              Sign in link
                            </a>
                            <a href="{{ asset ('') }}assets/sign-in-illustration.html" class="dropdown-item">
                              Sign in with illustration
                            </a>
                            <a href="{{ asset ('') }}assets/sign-in-cover.html" class="dropdown-item">
                              Sign in with cover
                            </a>
                            <a href="{{ asset ('') }}assets/sign-up.html" class="dropdown-item">
                              Sign up
                            </a>
                            <a href="{{ asset ('') }}assets/forgot-password.html" class="dropdown-item">
                              Forgot password
                            </a>
                            <a href="{{ asset ('') }}assets/terms-of-service.html" class="dropdown-item">
                              Terms of service
                            </a>
                            <a href="{{ asset ('') }}assets/auth-lock.html" class="dropdown-item">
                              Lock screen
                            </a>
                            <a href="{{ asset ('') }}assets/2-step-verification.html" class="dropdown-item">
                              2 step verification
                            </a>
                            <a href="{{ asset ('') }}assets/2-step-verification-code.html" class="dropdown-item">
                              2 step verification code
                            </a>
                          </div>
                        </div>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/blank.html">
                          Blank page
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/badges.html">
                          Badges
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/buttons.html">
                          Buttons
                        </a>
                        <div class="dropend">
                          ...
                          <div class="dropdown-menu">
                            <a href="{{ asset ('') }}assets/cards.html" class="dropdown-item">
                              Sample cards
                            </a>
                            <a href="{{ asset ('') }}assets/card-actions.html" class="dropdown-item">
                              Card actions
                              <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                            </a>
                            <a href="{{ asset ('') }}assets/cards-masonry.html" class="dropdown-item">
                              Cards Masonry
                            </a>
                          </div>
                        </div>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/carousel.html">
                          Carousel
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/charts.html">
                          Charts
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/colors.html">
                          Colors
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/colorpicker.html">
                          Color picker
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/datagrid.html">
                          Data grid
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/datatables.html">
                          Datatables
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/dropdowns.html">
                          Dropdowns
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/dropzone.html">
                          Dropzone
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <div class="dropend">
                          ...
                          <div class="dropdown-menu">
                            <a href="{{ asset ('') }}assets/error-404.html" class="dropdown-item">
                              404 page
                            </a>
                            <a href="{{ asset ('') }}assets/error-500.html" class="dropdown-item">
                              500 page
                            </a>
                            <a href="{{ asset ('') }}assets/error-maintenance.html" class="dropdown-item">
                              Maintenance page
                            </a>
                          </div>
                        </div>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/flags.html">
                          Flags
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/inline-player.html">
                          Inline player
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                      </div>
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ asset ('') }}assets/lightbox.html">
                          Lightbox
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/lists.html">
                          Lists
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/modals.html">
                          Modal
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/maps.html">
                          Map
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/map-fullsize.html">
                          Map fullsize
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/maps-vector.html">
                          Map vector
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/markdown.html">
                          Markdown
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/navigation.html">
                          Navigation
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/offcanvas.html">
                          Offcanvas
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/pagination.html">
                          <!-- Download SVG icon from http://tabler-icons.io/i/pie-chart -->
                          Pagination
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/placeholder.html">
                          Placeholder
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/steps.html">
                          Steps
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/stars-rating.html">
                          Stars rating
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/tabs.html">
                          Tabs
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/tables.html">
                          Tables
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/typography.html">
                          Typography
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/tinymce.html">
                          TinyMCE
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                      </div>
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="{{ asset ('') }}assets/form-elements.html" >
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ asset ('') }}assets/empty.html">
                          Empty page
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/cookie-banner.html">
                          Cookie banner
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/activity.html">
                          Activity
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/gallery.html">
                          Gallery
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/invoice.html">
                          Invoice
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/search-results.html">
                          Search results
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/pricing.html">
                          Pricing cards
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/pricing-table.html">
                          Pricing table
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/faq.html">
                          FAQ
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/users.html">
                          Users
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/license.html">
                          License
                        </a>
                      </div>
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ asset ('') }}assets/logs.html">
                          Logs
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/music.html">
                          Music
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/photogrid.html">
                          Photogrid
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/tasks.html">
                          Tasks
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/uptime.html">
                          Uptime monitor
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/widgets.html">
                          Widgets
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/wizard.html">
                          Wizard
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/settings.html">
                          Settings
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/trial-ended.html">
                          Trial ended
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/job-listing.html">
                          Job listing
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/page-loader.html">
                          Page loader
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                      </div>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-horizontal.html">
                          Horizontal
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-boxed.html">
                          Boxed
                          <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-vertical.html">
                          Vertical
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-vertical-transparent.html">
                          Vertical transparent
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-vertical-right.html">
                          Right vertical
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-condensed.html">
                          Condensed
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-combo.html">
                          Combined
                        </a>
                      </div>
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-navbar-dark.html">
                          Navbar dark
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-navbar-sticky.html">
                          Navbar sticky
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-navbar-overlap.html">
                          Navbar overlap
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-rtl.html">
                          RTL mode
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-fluid.html">
                          Fluid
                        </a>
                        <a class="dropdown-item" href="{{ asset ('') }}assets/layout-fluid-vertical.html">
                          Fluid vertical
                        </a>
                      </div>
                    </div>
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ asset ('') }}assets/icons.html" >
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="{{ asset ('') }}assets/changelog.html">
                      Changelog
                    </a>
              ...
              <div class="my-2 my-md-0 flex-grow-1 flex-md-grow-0 order-first order-md-last">
                <form action="{{ asset ('') }}assets/" method="get" autocomplete="off" novalidate>
                              ...
                              <div class="col-6 col-sm-4">
                                <label class="form-imagecheck mb-2">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{ asset ('') }}assets/static/photos/beautiful-blonde-woman-relaxing-with-a-can-of-coke-on-a-tree-stump-by-the-beach.jpg" alt="Beautiful blonde woman relaxing with a can of coke on a tree stump by the beach" class="form-imagecheck-image">
                                  </span>
                                </label>
                              </div>
                              <div class="col-6 col-sm-4">
                                <label class="form-imagecheck mb-2">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{ asset ('') }}assets/static/photos/brainstorming-session-with-creative-designers.jpg" alt="Brainstorming session with creative designers" class="form-imagecheck-image">
                                  </span>
                                </label>
                              </div>
                              <div class="col-6 col-sm-4">
                                <label class="form-imagecheck mb-2">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{ asset ('') }}assets/static/photos/finances-us-dollars-and-bitcoins-currency-money.jpg" alt="Finances - US Dollars and Bitcoins - Currency - Money" class="form-imagecheck-image">
                                  </span>
                                </label>
                              </div>
                              <div class="col-6 col-sm-4">
                                <label class="form-imagecheck mb-2">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{ asset ('') }}assets/static/photos/group-of-people-brainstorming-and-taking-notes-2.jpg" alt="Group of people brainstorming and taking notes" class="form-imagecheck-image">
                                  </span>
                                </label>
                              </div>
                              <div class="col-6 col-sm-4">
                                <label class="form-imagecheck mb-2">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{ asset ('') }}assets/static/photos/blue-sofa-with-pillows-in-a-designer-living-room-interior.jpg" alt="Blue sofa with pillows in a designer living room interior" class="form-imagecheck-image">
                                  </span>
                                </label>
                              </div>
                              <div class="col-6 col-sm-4">
                                <label class="form-imagecheck mb-2">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{ asset ('') }}assets/static/photos/home-office-desk-with-macbook-iphone-calendar-watch-and-organizer.jpg" alt="Home office desk with Macbook, iPhone, calendar, watch & organizer" class="form-imagecheck-image">
                                  </span>
                                </label>
                              </div>
                            </div>
                            ...
                            <div class="row g-2">
                              <div class="col-6 col-sm-4">
                                <label class="form-imagecheck mb-2">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{ asset ('') }}assets/static/photos/group-of-people-sightseeing-in-the-city.jpg" alt="Group of people sightseeing in the city" class="form-imagecheck-image">
                                  </span>
                                </label>
                              </div>
                              <div class="col-6 col-sm-4">
                                <label class="form-imagecheck mb-2">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{ asset ('') }}assets/static/photos/color-palette-guide-sample-colors-catalog-.jpg" alt="Color Palette Guide. Sample Colors Catalog." class="form-imagecheck-image">
                                  </span>
                                </label>
                              </div>
                              <div class="col-6 col-sm-4">
                                <label class="form-imagecheck mb-2">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{ asset ('') }}assets/static/photos/stylish-workplace-with-computer-at-home.jpg" alt="Stylish workplace with computer at home" class="form-imagecheck-image">
                                  </span>
                                </label>
                              </div>
                              <div class="col-6 col-sm-4">
                                <label class="form-imagecheck mb-2">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{ asset ('') }}assets/static/photos/pink-desk-in-the-home-office.jpg" alt="Pink desk in the home office" class="form-imagecheck-image">
                                  </span>
                                </label>
                              </div>
                              <div class="col-6 col-sm-4">
                                <label class="form-imagecheck mb-2">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{ asset ('') }}assets/static/photos/young-woman-sitting-on-the-sofa-and-working-on-her-laptop.jpg" alt="Young woman sitting on the sofa and working on her laptop" class="form-imagecheck-image">
                                  </span>
                                </label>
                              </div>
                              <div class="col-6 col-sm-4">
                                <label class="form-imagecheck mb-2">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{ asset ('') }}assets/static/photos/coffee-on-a-table-with-other-items.jpg" alt="Coffee on a table with other items" class="form-imagecheck-image">
                                  </span>
                                </label>
                              </div>
                            </div>
                            ...
                            <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                              <label class="form-selectgroup-item flex-fill">
                                ...
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                  ...
                                  <div class="form-selectgroup-label-content d-flex align-items-center">
                                    <span class="avatar me-3" style="background-image: url({{ asset ('') }}assets/static/avatars/000m.jpg)"></span>
                                    <div>
                              ...
                              <label class="form-selectgroup-item flex-fill">
                                ...
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                  ...
                                  <div class="form-selectgroup-label-content d-flex align-items-center">
                                    <span class="avatar me-3" style="background-image: url({{ asset ('') }}assets/static/avatars/002m.jpg)"></span>
                                    <div>
                              ...
                              <label class="form-selectgroup-item flex-fill">
                                ...
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                  ...
                                  <div class="form-selectgroup-label-content d-flex align-items-center">
                                    <span class="avatar me-3" style="background-image: url({{ asset ('') }}assets/static/avatars/003m.jpg)"></span>
                                    <div>
                              ...
                              <label class="form-selectgroup-item flex-fill">
                                ...
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                  ...
                                  <div class="form-selectgroup-label-content d-flex align-items-center">
                                    <span class="avatar me-3" style="background-image: url({{ asset ('') }}assets/static/avatars/000f.jpg)"></span>
                                    <div>
                        ...
                        <div class="col-md-6 col-xl-12">
                          ...
                          <div class="mb-3">
                            ...
                            <select type="text" class="form-select" id="select-people" value="">
                              <option value="1" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/000m.jpg)&quot;&gt;&lt;/span&gt;">Paweł Kuna</option>
                              <option value="2" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot;&gt;JL&lt;/span&gt;">Jeffie Lewzey</option>
                              <option value="3" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/002m.jpg)&quot;&gt;&lt;/span&gt;">Mallory Hulme</option>
                              <option value="4" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/003m.jpg)&quot;&gt;&lt;/span&gt;">Dunn Slane</option>
                              <option value="5" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/000f.jpg)&quot;&gt;&lt;/span&gt;">Emmy Levet</option>
                              <option value="6" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/001f.jpg)&quot;&gt;&lt;/span&gt;">Maryjo Lebarree</option>
                              <option value="7" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot;&gt;EP&lt;/span&gt;">Egan Poetz</option>
                              <option value="8" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/002f.jpg)&quot;&gt;&lt;/span&gt;">Kellie Skingley</option>
                              <option value="9" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/003f.jpg)&quot;&gt;&lt;/span&gt;">Christabel Charlwood</option>
                              <option value="10" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot;&gt;HS&lt;/span&gt;">Haskel Shelper</option>
                              <option value="11" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/006m.jpg)&quot;&gt;&lt;/span&gt;">Lorry Mion</option>
                              <option value="12" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/004f.jpg)&quot;&gt;&lt;/span&gt;">Leesa Beaty</option>
                              <option value="13" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/007m.jpg)&quot;&gt;&lt;/span&gt;">Perren Keemar</option>
                              <option value="14" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot;&gt;SA&lt;/span&gt;">Sunny Airey</option>
                              <option value="15" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/009m.jpg)&quot;&gt;&lt;/span&gt;">Geoffry Flaunders</option>
                              <option value="16" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/010m.jpg)&quot;&gt;&lt;/span&gt;">Thatcher Keel</option>
                              <option value="17" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/005f.jpg)&quot;&gt;&lt;/span&gt;">Dyann Escala</option>
                              <option value="18" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/006f.jpg)&quot;&gt;&lt;/span&gt;">Avivah Mugleston</option>
                              <option value="19" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot;&gt;AA&lt;/span&gt;">Arlie Armstead</option>
                              <option value="20" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{ asset ('') }}assets/static/avatars/008f.jpg)&quot;&gt;&lt;/span&gt;">Tessie Curzon</option>
                            </select>
                          </div>
                          <div class="mb-3">
                  ...
                  <form class="card">
                    ...
                    <div class="card-body">
                      <div class="mb-3">
                        <div class="row">
                          <div class="col-auto">
                            <span class="avatar avatar-md" style="background-image: url({{ asset ('') }}assets/static/avatars/002m.jpg)"></span>
                          </div>
                          <div class="col">
                            <div class="mb-3">
          ...
          <div class="row text-center align-items-center flex-row-reverse">
            <div class="col-lg-auto ms-lg-auto">
              <ul class="list-inline list-inline-dots mb-0">
                ...
                <li class="list-inline-item"><a href="{{ asset ('') }}assets/license.html" class="link-secondary">License</a></li>
