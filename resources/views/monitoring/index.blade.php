            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-3 mt-4">
                        ...
                        <a href="{{ route('monitoring.process-excel') }}" class="btn btn-success" id="exportBtn">Export</a>
                    </div>
                </div>
                <iframe id="searchMonitoringProcess" src="" style="width: 100%; height: 500px; border: none;"></iframe>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        //tampilan data
        var iframeSrc = '{{ route('monitoring.process-data') }}?period=' + encodeURIComponent(period) +
            '&number=' + encodeURIComponent(number) +
            '&division=' + encodeURIComponent(division) +
            '&official=' + encodeURIComponent(official);
        console.log(iframeSrc);
        $('#searchMonitoringProcess').attr('src', iframeSrc);
        }
        ...
        var url = $('#searchMonitoringProcess').attr('src');
         // Validasi form
