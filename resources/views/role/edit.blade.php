        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name', $role->name) }}" @if($role->id == 1) readonly @endif>
                        @error('name')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-check form-check-inline">
                                    ...
                                    @if($role->permissions->contains($item))
                                        checked
                                    @endif
                                    id="check-{{ $item->id }}" value="{{ $item->name }}" class="form-check-input">
