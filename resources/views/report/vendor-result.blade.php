...
<body>
    ...
    <p style="text-align: center; font-size: 16pt">Daftar Penyedia Jasa / Vendor {{ $status }}<br>PT. Citra Marga Nusaphala Persada, Tbk<br>Periode : {{ $formattedStartDate }} - {{ $formattedEndDate }}</p>
