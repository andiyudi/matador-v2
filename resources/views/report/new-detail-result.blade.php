...
<body>
    ...
    <p style="text-align: center; font-size: 16pt">Daftar Penyedia Jasa / Vendor Baru<br>PT. Citra Marga Nusaphala Persada, Tbk<br>Periode : {{ $formattedStartDateJoin }} - {{ $formattedEndDateJoin }}</p>
